...
const routes: Routes = [
  ...
  { path: 'programmes/recette/shampoings', component: ShampoingsComponent},
  { path: 'programmes/recette/lotion-creme', component:LotionCremeComponent},
  { path: 'programmes/recette/masques', component: MasquesComponent},

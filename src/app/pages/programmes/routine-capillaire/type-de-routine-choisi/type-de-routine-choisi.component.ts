...
@Component({
  selector: 'app-type-de-routine-choisi',
  templateUrl: './type-de-routine-choisi.component.html',
  styleUrls: ['./type-de-routine-choisi.component.scss']
})
export class TypeDeRoutineChoisiComponent implements OnInit {
  page: boolean = true;
